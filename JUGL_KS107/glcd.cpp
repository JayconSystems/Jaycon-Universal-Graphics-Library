 ...
 *
 * @param color GLCD_BLACK or GLCD_WHITE
 *
 * Sets all the pixels on the display from 0,0 to GLCD.Width-1,GLCD.Height-1
 * to the specified color.
 *
 * Color is optional and defaults to GLCD_WHITE.
 *
 * @note
 * If the display is in INVERTED mode, then the color GLCD_WHITE will paint the screen
 * GLCD_BLACK and the color GLCD_BLACK will paint the screen GLCD_WHITE.
 *
 *
 */
 ...
 *
 * Color is optional and defaults to GLCD_BLACK.
 *
 * @see DrawHLine()
 * @see DrawVLine()
 *
 ...
 * GLCD_BLACK pixels becom GLCD_WHITE and GLCD_WHITE pixels become GLCD_BLACK.
 *
...
uint8_t i, j;
  ...
  if( (y & 7) || (height & 7))
  {
  	this->FillRect(x, y, width, height, GLCD_WHITE);
  }
#endif
 ...
 *
 * color of GLCD_BLACK or GLCD_WHITE is an optional parameter indicating pixel color, default is GLCD_BLACK
 *
 ...
 *
 * color is an optional parameter indicating pixel color and defaults to GLCD_BLACK
 *
 ...
 * @param yCenter Y coordinate of the center of the circle
 * @param radius radius of circle
 * @param color GLCD_WHITE or GLCD_BLACK
 *
