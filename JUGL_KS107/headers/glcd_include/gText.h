...
#include "WString.h"
#include "headers/glcd_include/Streaming.h" 
...
/*@{*/
	...
	// Font Functions
	void SelectFont(Font_t font, uint8_t color=GLCD_BLACK, FontCallback callback=ReadPgmData); // default arguments added, callback now last arg
