...
#include "Arduino.h"
#endif
#include "headers/glcd_include/arduino_io.h"    // these macros map arduino pins
...
#include "headers/glcd_include/avrio.h"         // these macros do direct port io    
 ...
 */
#include "headers/glcd_include/delay.h" // Hans' Heirichs delay macros
