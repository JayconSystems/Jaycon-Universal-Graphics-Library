...
#include "headers/glcd_config/ks0108_Mega.h"      // config for mega 1280/2560 board
#elif defined(__AVR_ATmega644P__)  || defined(__AVR_ATmega644__)           
#include "headers/glcd_config/ks0108_Sanguino.h"  // config for Sanguino or other ATmega644/p board
#elif defined(__AVR_AT90USB646__) || defined(__AVR_AT90USB1286__) || defined(__AVR_ATmega32U4__)// Teensy
#include "headers/glcd_config/ks0108_Teensy.h"    // config for Teensy and Teensy++  
#else
#include "headers/glcd_config/ks0108_Arduino.h"   // config file for standard Arduino using documented wiring 
#endif

#include "headers/glcd_device/ks0108_Device.h"
