...
#include "glcd_include/gText.h" 

#define GLCD_VERSION 3 // software version of this library

// coppied from glcd_Device.h so that it can be seen from JUGL-side
...
/*@{*/
	// Graphic Functions
	void ClearScreen(uint8_t color = GLCD_WHITE);
	void DrawVLine(uint8_t x, uint8_t y, uint8_t height, uint8_t color= GLCD_BLACK);
	void DrawHLine(uint8_t x, uint8_t y, uint8_t width, uint8_t color= GLCD_BLACK);
	void DrawLine(uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, uint8_t color= GLCD_BLACK);
	void DrawRect(uint8_t x, uint8_t y, uint8_t width, uint8_t height, uint8_t color= GLCD_BLACK);
	void DrawRoundRect(uint8_t x, uint8_t y, uint8_t width, uint8_t height, uint8_t radius, uint8_t color= GLCD_BLACK);
	void FillRect(uint8_t x, uint8_t y, uint8_t width, uint8_t height, uint8_t color= GLCD_BLACK);
	void InvertRect(uint8_t x, uint8_t y, uint8_t width, uint8_t height);
	void DrawCircle(uint8_t xCenter, uint8_t yCenter, uint8_t radius, uint8_t color= GLCD_BLACK);	
	void FillCircle(uint8_t xCenter, uint8_t yCenter, uint8_t radius, uint8_t color= GLCD_BLACK);	
	void DrawBitmap(Image_t bitmap, uint8_t x, uint8_t y, uint8_t color= GLCD_BLACK);
#ifdef NOTYET
	void DrawBitmapXBM(ImageXBM_t bitmapxbm, uint8_t x, uint8_t y, uint8_t color= GLCD_BLACK);
...
//extern glcd GLCD;   // we don't want a global reference to this
#endif
